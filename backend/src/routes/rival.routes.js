...
import { getSpectators, joinSpectator, leaveSpectator, disputeSpectator } from '../controllers/spectator.controller.js';
...
router.post('/:id/leave-as-promoted-substitute', authenticate, leaveAsPromotedSubstitute);
...
router.patch('/:id/participant-position', authenticate, setParticipantPosition);
router.post('/:id/participant-position/suggest', authenticate, suggestOwnPosition);
router.patch('/:id/participant-position/suggest/respond', authenticate, respondPositionSuggestion);
...
router.post('/:id/spectators/:spectatorUserId/dispute', authenticate, disputeSpectator);
