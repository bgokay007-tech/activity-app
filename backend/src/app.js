...
import teamNameRoutes from './routes/teamName.routes.js';
...
import racquetFeedbackRoutes from './routes/racquetFeedback.routes.js';
...
app.use('/api/team-names', teamNameRoutes);
...
app.use('/api/racquet-feedback', racquetFeedbackRoutes);
