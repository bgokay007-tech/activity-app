...
const ALL_BRANCHES = [
    ...
    { key: 'friend_finding',    label: '🎉 Arkadaş Bulma',            category: 'SOCIAL', subCategory: 'friend_finding' },
    { key: 'sanal_alem',        label: '🌐 Sanal Alem',               category: 'SOCIAL', subCategory: 'sanal_alem' },
    { key: 'travel_explore',    label: '✈️ Seyahat / Keşfetme',       category: 'SOCIAL', subCategory: 'travel_explore' },
